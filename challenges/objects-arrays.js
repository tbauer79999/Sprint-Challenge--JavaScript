...
zooAnimals.forEach (arrItem => {
  displayNames.push(`${arrItem.animal_name}`);
  displayNames.push(`${arrItem.scientific_name}`);
})
...
lowCaseAnimalNames.map (arrItem => {
  arrItem.push(`${arrItem.animal_name.toLowerCase}`);
})
